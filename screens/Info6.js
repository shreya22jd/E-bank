...
const Info6 = () => {
  ...
  return (
    <View style={styles.info16}>
      <View style={[styles.info16Child, styles.info16Bg]} />
      <View style={[styles.info16Item, styles.info16Bg]} />
      <Pressable
        style={[styles.info16Inner, styles.parentFlexBox]}
