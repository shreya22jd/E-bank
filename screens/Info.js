...
const Info = () => {
  ...
  return (
    <View style={styles.info17}>
      <View style={[styles.info17Child, styles.info17Bg]} />
      <View style={[styles.info17Item, styles.info17Bg]} />
      <Pressable
        style={[styles.info17Inner, styles.parentFlexBox]}
      ...
      <View style={[styles.statusBarwhite, styles.rectangleViewPosition]}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/connections3.png")}
        />
      </View>
